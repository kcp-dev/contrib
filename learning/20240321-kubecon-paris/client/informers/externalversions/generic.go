...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericClusterInformer, error) {
	...
	case trainingv1alpha1.SchemeGroupVersion.WithResource("models"):
		return &genericClusterInformer{resource: resource.GroupResource(), informer: f.Training().V1alpha1().Models().Informer()}, nil
	}
...
func (f *sharedScopedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	// Group=training.faros.sh, Version=V1alpha1
	case trainingv1alpha1.SchemeGroupVersion.WithResource("models"):
		informer := f.Training().V1alpha1().Models().Informer()
