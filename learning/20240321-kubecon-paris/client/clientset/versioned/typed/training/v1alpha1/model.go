...
import (
	...
	scheme "github.com/faroshq/kcp-ml-shop/client/clientset/versioned/scheme"
...
type ModelInterface interface {
	...
	Apply(ctx context.Context, model *trainingv1alpha1.ModelApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Model, err error)
	ApplyStatus(ctx context.Context, model *trainingv1alpha1.ModelApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Model, err error)
	ModelExpansion
}
...
func newModels(c *TrainingV1alpha1Client) *models {
	return &models{
		client: c.RESTClient(),
	}
}
...
func (c *models) Apply(ctx context.Context, model *trainingv1alpha1.ModelApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Model, err error) {
	if model == nil {
...
func (c *models) ApplyStatus(ctx context.Context, model *trainingv1alpha1.ModelApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Model, err error) {
	if model == nil {
		return nil, fmt.Errorf("model provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
