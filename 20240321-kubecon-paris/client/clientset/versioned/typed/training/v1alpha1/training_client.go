...
import (
	...
	"github.com/faroshq/kcp-ml-shop/client/clientset/versioned/scheme"
...
// TrainingV1alpha1Client is used to interact with features provided by the training.faros.sh group.
type TrainingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *TrainingV1alpha1Client) Models() ModelInterface {
	return newModels(c)
}
