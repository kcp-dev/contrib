...
import (
	...
	traininginformers "github.com/faroshq/kcp-ml-shop/client/informers/externalversions/training"
...
type SharedInformerFactory interface {
	...
	Training() traininginformers.ClusterInterface
}

func (f *sharedInformerFactory) Training() traininginformers.ClusterInterface {
	return traininginformers.New(f, f.tweakListOptions)
}
...
type SharedScopedInformerFactory interface {
	...
	Training() traininginformers.Interface
}

func (f *sharedScopedInformerFactory) Training() traininginformers.Interface {
	return traininginformers.NewScoped(f, f.namespace, f.tweakListOptions)
}
