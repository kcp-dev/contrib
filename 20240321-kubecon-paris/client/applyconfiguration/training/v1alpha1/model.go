...
import (
	v1 "github.com/faroshq/kcp-ml-shop/client/applyconfiguration/meta/v1"
...
// apply.
func Model(name string) *ModelApplyConfiguration {
	b := &ModelApplyConfiguration{}
	b.WithName(name)
	b.WithKind("Model")
	b.WithAPIVersion("training.faros.sh/v1alpha1")
	return b
}
